...
describe "BeermappingApi" do
  it "When HTTP GET doesnt return entry" do
    ...
    END_OF_STRING
    stub_request(:get, /.*korpi/).to_return(body: canned_answer, headers: { 'Content-Type' => "text/xml" })

    places = BeermappingApi.places_in("korpi")
